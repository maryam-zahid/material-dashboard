type TableProjectProgressProps = {
  value: number;
};

export function TableProjectProgress({
  value,
}: TableProjectProgressProps) {
  return (
    <div className="flex w-[242px] items-center gap-1.5">
      ...
      <div className="h-[6px] w-[182px] overflow-hidden rounded-[10px] bg-[#F5F5F4]">
        <div
